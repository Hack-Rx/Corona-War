...
<link rel="stylesheet" href="css/glyphicon.css">
  ...
  $(document).ready(function() {
    ...
    <div class="col-xs-5">
                      <textarea id="textarea" class="form-control"rows="8" cols="100" maxlength="3000" name="question" placeholder = "Enter your query here..." required="true"></textarea>
    ...
    <div class="tracker row" id="stats">
      
    <iframe class="col-xs-12 col-md-6" style="margin-left: 60px" src="https://app.developer.here.com/coronavirus/" frameborder="0"></iframe>
      </div>
